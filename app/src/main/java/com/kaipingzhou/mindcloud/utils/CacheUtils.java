    ...
    public static void putString(Context context, String key, String value) {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            try {
                ...
                File file = new File(Environment.getExternalStorageDirectory() + "/" + Constants.APP_PATH + "/files", fileName);
        ...
        for (String key : keys) {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                try {
                    ...
                    File file = new File(Environment.getExternalStorageDirectory() + "/智慧云/files", fileName);
